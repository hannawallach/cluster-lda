...
ID=`expr $SGE_TASK_ID`
make results/cluster_lda/$4/T$5-C1-SG10000-SC1-ST1-THETA$1-EPS$2-SAMPLEfalse-PERCLUSTERtrue-DOCCOUNTStrue-$3-ID${ID} T=$5 C=1 SG=10000 SC=1 ST=1 THETA=$1 EPS=$2 SAMPLE=false PERCLUSTER=true DOCCOUNTS=true PRIOR=$3 ID=${ID} STATE_FILE=$6
