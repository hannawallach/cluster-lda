...
ID=`expr $SGE_TASK_ID`
make results/cluster_lda/$3/T$4-C25-SG2000-SC1-ST1-THETA$1-SAMPLEfalse-PERCLUSTERfalse-DOCCOUNTStrue-$2-ID${ID} T=$4 C=25 SG=2000 SC=1 ST=1 THETA=$1 SAMPLE=false PERCLUSTER=false DOCCOUNTS=true PRIOR=$2 ID=${ID} STATE_FILE=$5
